...
<template>
  <div>
    <h2 v-if="!editing" class="font-semibold text-2xl">
      <UButton variant="subtle" color="neutral" icon="i-lucide-edit" @click="editing = true" />
      {{ task.title }}
    </h2>
    <UForm v-else :schema="taskTitleSchema" :state="taskTitle" @submit="saveTitle">
